...
void Minecraft::Client::World::Init()
{
	...
	chunkManagerThread = sceKernelCreateThread("ChunkManager", chunkManagement, 0x18, 0x10000, THREAD_ATTR_VFPU | THREAD_ATTR_USER, NULL);
...
{
	return DoChunkManagement();
}

int Minecraft::Client::World::DoChunkManagement(){
		mc::Vector3i last_pos = mc::Vector3i(0, -1, 0);
	while(true){
